...
**Note**: This version used different `MSIMPA` parameters for each layer.
...
# 2
tot_int <- dplyr::bind_rows(C_t, O_t, Zn_t)
#3 
C_20_nm_ZnO_15kV <- prepend_sample_id_max_int_tib(tot_int, out_ti)
# 4
panderOptions('table.split.table', Inf)
pander(C_20_nm_ZnO_15kV)
# 5
save(C_20_nm_ZnO_15kV, file="C_20_nm_ZnO_15kV.rda")
# delete and reload be sure it worked...
rm(C_20_nm_ZnO_15kV)
load("./C_20_nm_ZnO_15kV.rda")
```
