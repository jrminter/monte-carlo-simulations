---
title: "20-nm-C-250-nm-ZnO-Silica-15kV-reflin-3e-1"
author: "John Minter"
...
abstract: |
  ...
  $3.0e^{-1}$.  This was a fairly weak transition (0.1140) compared to the
...
and a `REFLIN` parameter (`3.E-1`) to finish.

```
RSEED  -10   1                 [Seeds of the random-number generator]
REFLIN 30040800 1 3.E-1     [Zn L3-M4 IZ*1e6+S1*1e4+S2*1e2,dete,tol.]
...
sim_nam     <- "20-nm-C-250-nm-ZnO-Silica-reflin-3e-1"
...
C_20_nm_ZnO_250_nm_SiO2_15kV_reflin_3e_m1_ro <- tmp_v
rm(tmp_v)

save(C_20_nm_ZnO_250_nm_SiO2_15kV_reflin_3e_m1_ro,
     file="./C_20_nm_ZnO_250_nm_SiO2_15kV_reflin_3e_m1_ro.rda")
rm(C_20_nm_ZnO_250_nm_SiO2_15kV_reflin_3e_m1_ro)
load("./C_20_nm_ZnO_250_nm_SiO2_15kV_reflin_3e_m1_ro.rda")
pander(C_20_nm_ZnO_250_nm_SiO2_15kV_reflin_3e_m1_ro)
```
...
#3 
C_20_nm_ZnO_250_nm_SiO2_15kV_reflin_3e_m1 <- prepend_sample_id_max_int_tib(tot_int, out_ti)
# 4
pander(C_20_nm_ZnO_250_nm_SiO2_15kV_reflin_3e_m1)
# 5
save(C_20_nm_ZnO_250_nm_SiO2_15kV_reflin_3e_m1,
     file="C_20_nm_ZnO_250_nm_SiO2_15kV_reflin_3e_m1.rda")
# delete and reload be sure it worked...
rm(C_20_nm_ZnO_250_nm_SiO2_15kV_refli2n)
load("./C_20_nm_ZnO_250_nm_SiO2_15kV_reflin_3e_m1.rda")
```
